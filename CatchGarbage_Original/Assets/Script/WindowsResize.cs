...
public class WindowsResize : MonoBehaviour {
    ...
    void Resize() {
        ...
        farBuilding.position = new Vector3(0, 0.2f, 0);
        nearBuilding.position = new Vector3(0, -1.2f, 0);
        bush.position = new Vector3(0, -2.5f, 0);

        ground.position = new Vector3(0, -_position.y + groundSpriteRender.bounds.size.y / 2, 0);
        leftBuilding.position = new Vector3(-_position.x + leftBuildingSpriteRender.bounds.size.x / 4, 0);
        rightBuilding.position = new Vector3(_position.x - rightBuildingSpriteRender.bounds.size.x / 4, 0);
